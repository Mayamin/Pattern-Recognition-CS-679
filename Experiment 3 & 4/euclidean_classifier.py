...
# reading dataset A
df_1 = np.array(pd.read_csv('../DatasetGeneration/dataset_A.csv', sep=',', header=None))
# df_2 = pd.read_csv("/home/mraha/Desktop/myproject/src/dataset_A.csv")

# reading datset B
df_3 = np.array(pd.read_csv('../DatasetGeneration/dataset_B.csv', sep=',', header=None))
...
total_misclassification_rate_A = ((incorrect_predictions_class0_A + incorrect_predictions_class1_A) / 200000.00)*100
total_misclassification_rate_B = ((incorrect_predictions_class0_B + incorrect_predictions_class1_B )/ 200000)*100
