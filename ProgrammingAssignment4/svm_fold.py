...
def svm_fold_x(img_no,fold_no):
    ...
    if (fold_no==2):
        ...
        dataframe1 = pd.read_csv(path_tr02)
        ...
        #read train img_label
        dataframe2 = pd.read_csv(path_Ttr02)
        ...
        #read test img coeff
        dataframe3 = pd.read_csv(path_ts02)
        ...
        #read test img_label
        dataframe4 = pd.read_csv(path_Tts02)
    ...
    if (fold_no==3):
        ...
        dataframe1 = pd.read_csv(path_tr03)
        ...
        #read train img_label
        dataframe2 = pd.read_csv(path_Ttr03)
        ...
        #read test img coeff
        dataframe3 = pd.read_csv(path_ts03)
        ...
        #read test img_label
        dataframe4 = pd.read_csv(path_Tts03)
