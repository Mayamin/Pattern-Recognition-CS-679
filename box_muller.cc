...
int main (int argc, char** argv)
{
    ...
    fstream fout_1;
    fout_1.open("dataset_A_part1.csv", ios::out);
    fout_1<< "x" << ","<< "y"<< " \n";


    fstream fout_2;
    fout_2.open("dataset_A_part2.csv", ios::out);
    fout_2<< "x" << ","<< "y"<< " \n";
    ...
    for (int i = 0; i < 60000; i++)
    {
        ...
        fout_1<< box_muller(1.0, 1.0)<< ","<< box_muller(1.0, 1.0)<< endl;
      //  printf(" x value %f, ", box_muller(1.0, 1.0));
       // printf(" y value %f, ", box_muller(1.0, 1.0));
    }

    for (int i = 0; i < 140000; i++)
    {
        
        fout_2<< box_muller(4.0, 1.0)<< ","<< box_muller(4.0, 1.0)<< endl;
      //  printf(" x value %f, ", box_muller(1.0, 1.0));
       // printf(" y value %f, ", box_muller(1.0, 1.0));
    }
